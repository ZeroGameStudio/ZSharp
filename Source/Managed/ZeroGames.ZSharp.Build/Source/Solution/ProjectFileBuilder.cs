...
public class ProjectFileBuilder
{
	...
	private XmlElement BuildItemGroupNode(XmlDocument doc, XmlElement projectNode)
	{
		...
		{
			finalStaticUsings.Add("ZeroGames.ZSharp.Core.UnrealEngine.AssertionMacros");
	...
	private const string CORE_ENGINE_ASSEMBLY_NAME = "ZeroGames.ZSharp.Core.UnrealEngine";
