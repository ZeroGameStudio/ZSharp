...
public sealed class UnrealText : PlainExportedObjectBase
    ...
    , IUnrealString
{
    ...
    {
        public int32 Compare(UnrealText? x, UnrealText? y) => InternalCompare(x, y);
    }
    ...
    private unsafe string InternalGetData()
    {
        ...
        return new(UnrealText_Interop.GetData(ConjugateHandle.FromConjugate(this)));
    }
