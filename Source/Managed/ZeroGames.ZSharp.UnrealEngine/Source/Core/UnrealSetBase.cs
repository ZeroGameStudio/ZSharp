...
public abstract class UnrealSetBase : PlainExportedObjectBase
{
	...
	public void Clear() => this.ZCall(MasterAlcCache.Instance, "ex://Set.Clear");

	public int32 Count => this.ZCall(MasterAlcCache.Instance, "ex://Set.Num", 0)[-1].Int32;
	...
	protected void Add(object? value) => this.ZCall(MasterAlcCache.Instance, "ex://Set.Add", value);
	protected void Remove(object? value) => this.ZCall(MasterAlcCache.Instance, "ex://Set.Remove", value);
	protected bool Contains(object? value) => this.ZCall(MasterAlcCache.Instance, "ex://Set.Contains", value, false)[-1].Bool;
