...
public readonly struct ZeroTaskCompletionSource<TResult>
{
	...
	public static ZeroTaskCompletionSource<TResult> Create(Lifecycle lifecycle = default)
	...
	private ZeroTaskCompletionSource(ZeroTaskBackend_CompletionSource<TResult> backend)
	{
		_backend = backend;
		_token = backend.Token;
	}
