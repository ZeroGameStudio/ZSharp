...
[Obsolete]
public class LegacyClassWriter : IDisposable, IAsyncDisposable
{

	public LegacyClassWriter(ExportedAssemblyRegistry registry, ExportedClass exportedClass, Stream stream)
	{
		_registry = registry;
