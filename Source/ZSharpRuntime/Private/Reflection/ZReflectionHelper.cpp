...
bool ZSharp::FZReflectionHelper::GetUFieldRuntimeTypeLocator(const UField* field, FZRuntimeTypeLocatorWrapper& outLocator)
{
	...
	outLocator.TypeName = FString::Printf(TEXT("%s.%s.%s"), *outLocator.AssemblyName, *moduleName, *ancestor->GetName());
...
bool ZSharp::FZReflectionHelper::GetFFieldClassRuntimeTypeLocator(const FFieldClass* cls, FZRuntimeTypeLocatorWrapper& outLocator)
{
	static const TMap<FFieldClass*, FZRuntimeTypeLocatorWrapper> GProtoMap
	{
		...
		// { FDelegateProperty::StaticClass(), { TZManagedTypeInfo<FSelfDescriptiveScriptDelegate>::GetAssemblyName(), TZManagedTypeInfo<FSelfDescriptiveScriptDelegate>::GetFullName(), {} } },
		// { FMulticastInlineDelegateProperty::StaticClass(), { TZManagedTypeInfo<FSelfDescriptiveMulticastScriptDelegate>::GetAssemblyName(), TZManagedTypeInfo<FSelfDescriptiveMulticastScriptDelegate>::GetFullName(), {} } },
		// { FMulticastSparseDelegateProperty::StaticClass(), { TZManagedTypeInfo<FSelfDescriptiveMulticastScriptDelegate>::GetAssemblyName(), TZManagedTypeInfo<FSelfDescriptiveMulticastScriptDelegate>::GetFullName(), {} } },
