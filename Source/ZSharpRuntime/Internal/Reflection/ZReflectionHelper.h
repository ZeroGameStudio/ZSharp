...
namespace ZSharp
{
	struct ZSHARPRUNTIME_API FZReflectionHelper
	{
		...
		static bool IsFunctionBindableToDelegate(const UFunction* function, const UDelegateFunction* delegate);
		static bool IsPropertyForceCopy(const FProperty* property);
	};
}
