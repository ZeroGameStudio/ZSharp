...
#define ZSHARP_UNMANAGED_FUNCTION_ASSEMBLY ZeroGames.ZSharp.UnrealEngine
			...
			ZSHARP_BUILD_UNMANAGED_FUNCTION(UnrealObject, BroadcastFieldValueChanged),
			ZSHARP_BUILD_UNMANAGED_FUNCTION(UnrealObject, MarkPropertyDirty),
			...
			ZSHARP_BUILD_UNMANAGED_FUNCTION(Actor, IsActorInitialized),
			ZSHARP_BUILD_UNMANAGED_FUNCTION(Actor, IsActorBeginningPlay),
			ZSHARP_BUILD_UNMANAGED_FUNCTION(Actor, HasActorBegunPlay),
