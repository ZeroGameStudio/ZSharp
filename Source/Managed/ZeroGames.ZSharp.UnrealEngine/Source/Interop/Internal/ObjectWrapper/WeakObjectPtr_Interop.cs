...
internal static unsafe class WeakObjectPtr_Interop
{
	...
	public static delegate* unmanaged<ConjugateHandle, ConjugateHandle, uint8> Equals;
	public static delegate* unmanaged<ConjugateHandle, int32> GetHashCode;
	...
	public static delegate* unmanaged<ConjugateHandle, uint8, uint8> IsStale;
}
